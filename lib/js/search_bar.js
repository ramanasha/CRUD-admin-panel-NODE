    ...
    $.post('/admin/clients/search', { clientData: $inputValue }).done(function (clients) {
        ...
        if (clients.length === 0) {
            ...
            clients.forEach((client, index) => {
                ...
                generatePets(client.pets, index)
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                ...
                                                <div class="form-group">
                                                    <input class="form-control" type="text" name="petName" placeholder="Nombre" />
                                                </div>
                                                <div class="form-group">
                                                    <input class="form-control" type="text" name="petBreed" placeholder="Raza"/> 
                                                </div>
                                                <div class="form-group">
                                                    <input class="form-control" type="text" name="petKind" placeholder="Especie"/> 
                                                </div>
                                                <div class="form-group">
                                                   <input class="form-control" type="text" name="petCoat" placeholder="Capa" />
                                                </div>
                                                       ...
                                                       Carácter
                                                        <div class="form-check">
                                                            <label class="form-check-label">
                                                                <input class="form-check-input mr-3" type="radio" name="attitude" value="Bueno" checked />
                                                                Bueno
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <label class="form-check-label">
                                                                <input class="form-check-input mr-3" type="radio" name="attitude" value="Nervioso" checked />
                                                                Nervioso
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <label class="form-check-label">
                                                                <input class="form-check-input mr-3" type="radio" name="attitude" value="Agresivo" checked />
                                                                Agresivo
                                                            </label>
                                                         </div>
                                                    </legend>
                                            ...
                                            <div class="card-block client-card">
                                                <h3 class="text-center py-2 px-1">Datos clínicos</h3>
                                                <div class="dropdown-divider"></div>
                                                <div class="form-group">
                                                    <input type="text" name="petMicrochip" placeholder="Número de identificación del Chip" class="form-control" />
                                                </div>
                                                <div class="form-check">
                                                    <label class="form-check-label">
                                                        <input class="form-check-input mr-3" type="checkbox"  value="" name="castrated"/>
                                                        ¿Castrado?
                                                    </label>
                                                </div>
                                                <fieldset>
                                                    <legend class="text-warning font-weight-bold">
                                                        Sexo
                                                        <div class="form-check form-check-inline">
                                                            <label class="form-check-label">
                                                                <input class="form-check-input ml-1 mr-2" type="radio" name="petGender" value="Macho" checked/>
                                                                Macho
                                                            </label>
                                                            <label class="form-check-label">
                                                                <input class="form-check-input ml-1 mr-2" type="radio" name="petGender" value="Hembra"/>
                                                                Hembra
                                                            </label>
                                                        </div>
                                                    </legend>
                                                ...
                                                <div class="form-group">
                                                   <label for="petAge">
                                                    Edad
                                                   <input type="number" id="petAge" name="petAge" min="0" max="20" class="form-control" />
                                                   </label>
                                                </div>
                                                <div class="form-check">
                                                    <div class="alert alert-danger">
                                                        <label class="form-check-label display-4">
                                                           <input class="bite form-check-input mr-3" type="checkbox" value="yes" name="bite" />
                                                           ¿ Muerde ?
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="dropdown-divider"></div>
                                                <div class="form-group">
                                                    <div class="d-flex justify-content-around vaccine">
                                                        <input class="vaccines" type="hidden" name="vaccines" value="0"/>
                                                        <h4>Vacunas</h4>
                                                        <button type="button" title="Nueva vacuna" class="btn alone-buttons newVaccine">
                                                            <i class="fa fa-fw fa-plus-square text-success"></i>
                                                        </button>
                                                    </div>
                                                    <div class="vaccineGroup list-group"></div>
                                                </div>
                                                <div class="dropdown-divider"></div>
                                                <div class="form-group">
                                                    <div class="d-flex justify-content-around diseases">
                                                        <input class="diseases" type="hidden" name="diseases" value="0"/>
                                                        <h4>Enfermedades</h4>
                                                        <button type="button" title="Nueva enfermedad" class="btn alone-buttons newDisease">
                                                            <i class="fa fa-fw fa-plus-square text-success"></i>
                                                        </button>
                                                    </div>
                                                    <div class="diseasesGroup list-group"></div>
                                                </div>
                                                <div class="dropdown-divider"></div>
                                                <div class="form-group">
...
function generatePets(pets, index) {
    if (pets.length > 0) {
        let petsArray = pets.toString().split(',').map(pet => pet);
        petsArray.forEach(function (petID) {
            $(`td.petInfo${index}`).append($('<span>', { class: 'd-none', text: petID }))
        })
    }
}
